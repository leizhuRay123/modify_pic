...
MODULE constants
  ...
  INTEGER, PARAMETER :: c_ic_df_power_law = 4
  INTEGER, PARAMETER :: c_ic_df_manual = 5
  ...
  REAL(num), PARAMETER :: hbar_qe_div_me = 1.854191916671692e-23
  ...
  REAL(num), PARAMETER :: Thomson_cross_section = 6.61198666074701e-29_num
  REAL(num), PARAMETER :: re = 2.8093553896519948e-15_num
  ...
  !XY for polarization
  INTEGER, PARAMETER :: c_dir_polar1 = c_ndims + 10
  INTEGER, PARAMETER :: c_dir_polar2 = c_ndims + 11
  INTEGER, PARAMETER :: c_dir_polar_degree = c_ndims + 12
  INTEGER, PARAMETER :: c_dir_polar_angle = c_ndims + 13
  INTEGER, PARAMETER :: c_dir_stokes_I = c_ndims + 14
  INTEGER, PARAMETER :: c_dir_stokes_Q = c_ndims + 15
  INTEGER, PARAMETER :: c_dir_stokes_U = c_ndims + 16
  INTEGER, PARAMETER :: c_dir_stokes_V = c_ndims + 17
  INTEGER, PARAMETER :: c_dir_stokes_N = c_ndims + 18
  !XY for rel
  INTEGER, PARAMETER :: c_dir_t = c_ndims + 19
...
!zzh
  INTEGER, PARAMETER :: c_const_io_derivation = 70
  INTEGER, PARAMETER :: c_const_io_derivation_single = 71
  ...
  !XY for polarization
  INTEGER, PARAMETER :: c_dump_part_generate_time     = 72
  INTEGER, PARAMETER :: c_dump_part_stokes_I1            = 73
  INTEGER, PARAMETER :: c_dump_part_stokes_I2            = 74
  INTEGER, PARAMETER :: c_dump_part_stokes_V            = 75

  INTEGER, PARAMETER :: c_dump_part_stokes_dirx        = 76
  INTEGER, PARAMETER :: c_dump_part_stokes_diry        = 77
  INTEGER, PARAMETER :: c_dump_part_stokes_dirz        = 78
  INTEGER, PARAMETER :: c_dump_i1_detect        = 79
  INTEGER, PARAMETER :: c_dump_i2_detect        = 80
  INTEGER, PARAMETER :: c_dump_polar_degree        = 81
  INTEGER, PARAMETER :: c_dump_polar_angle        = 82
  INTEGER, PARAMETER :: c_dump_stokes_I        = 83
  INTEGER, PARAMETER :: c_dump_stokes_U        = 84
  INTEGER, PARAMETER :: c_dump_stokes_Q        = 85
  INTEGER, PARAMETER :: c_dump_stokes_N        = 86
  INTEGER, PARAMETER :: c_dump_optical_stokes_I        = 87
  INTEGER, PARAMETER :: c_dump_optical_stokes_U        = 88
  INTEGER, PARAMETER :: c_dump_optical_stokes_Q        = 89
  INTEGER, PARAMETER :: c_dump_optical_stokes_N        = 90
  INTEGER, PARAMETER :: c_dump_total_optical_intensity_sum        = 91
!XY for fluid statistics
  INTEGER, PARAMETER :: c_dump_ux                = 92
  INTEGER, PARAMETER :: c_dump_uy                = 93
  INTEGER, PARAMETER :: c_dump_uz                = 94
  INTEGER, PARAMETER :: c_dump_Pxx               = 95
  INTEGER, PARAMETER :: c_dump_Pxy               = 96
  INTEGER, PARAMETER :: c_dump_Pxz               = 97
  INTEGER, PARAMETER :: c_dump_Pyy               = 98
  INTEGER, PARAMETER :: c_dump_Pyz               = 99
  INTEGER, PARAMETER :: c_dump_Pzz               = 100
  INTEGER, PARAMETER :: c_dump_thermalflux       = 101
  INTEGER, PARAMETER :: c_dump_gyrotropy         = 102
  INTEGER, PARAMETER :: c_dump_Hall_Ex           = 103
  INTEGER, PARAMETER :: c_dump_Hall_Ey           = 104
  INTEGER, PARAMETER :: c_dump_Hall_Ez           = 105
  INTEGER, PARAMETER :: c_dump_Nernst_Ex         = 106
  INTEGER, PARAMETER :: c_dump_Nernst_Ey         = 107
  INTEGER, PARAMETER :: c_dump_Nernst_Ez         = 108
  INTEGER, PARAMETER :: c_dump_Biermann_Ex       = 109
  INTEGER, PARAMETER :: c_dump_Biermann_Ey       = 110
  INTEGER, PARAMETER :: c_dump_Biermann_Ez       = 111
  INTEGER, PARAMETER :: c_dump_viscous_xyx_Ey    = 112
  INTEGER, PARAMETER :: c_dump_viscous_xzx_Ez    = 113
  INTEGER, PARAMETER :: c_dump_viscous_xyy_Ex    = 114
  INTEGER, PARAMETER :: c_dump_viscous_yzy_Ez    = 115
  INTEGER, PARAMETER :: c_dump_viscous_xzz_Ex    = 116
  INTEGER, PARAMETER :: c_dump_viscous_yzz_Ey    = 117
  INTEGER, PARAMETER :: c_dump_convection_Ex     = 118
  INTEGER, PARAMETER :: c_dump_convection_Ey     = 119
  INTEGER, PARAMETER :: c_dump_convection_Ez     = 120
  INTEGER, PARAMETER :: c_dump_rel_ux            = 121
  INTEGER, PARAMETER :: c_dump_rel_uy            = 122
  INTEGER, PARAMETER :: c_dump_rel_uz            = 123
  INTEGER, PARAMETER :: c_dump_rel_temperature_x  = 124
  INTEGER, PARAMETER :: c_dump_rel_temperature_y  = 125
  INTEGER, PARAMETER :: c_dump_rel_temperature_z  = 126
  INTEGER, PARAMETER :: c_dump_rel_temperature_t  = 127
  INTEGER, PARAMETER :: c_dump_magnetic_vector_potential  = 128
  !Compton
  INTEGER, PARAMETER :: c_dump_part_cs_times = 129
  !For static current
  INTEGER, PARAMETER :: c_dump_jx0 = 130
  INTEGER, PARAMETER :: c_dump_jy0 = 131
  INTEGER, PARAMETER :: c_dump_jz0 = 132
  !For calculate laser stokes
  INTEGER, PARAMETER :: c_dump_ey2 = 133
  INTEGER, PARAMETER :: c_dump_ez2 = 134
  INTEGER, PARAMETER :: c_dump_eyez = 135
  !supplementary for synchrotron circular polarization
  INTEGER, PARAMETER :: c_dump_optical_stokes_V        = 136

  
  INTEGER, PARAMETER :: num_vars_to_dump         = 136
