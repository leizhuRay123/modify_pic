...
CONTAINS
  ...
  SUBROUTINE mpi_initialise
...
#ifdef STATIC_FIELDS
    ALLOCATE(ex0(1-ng:nx+ng, 1-ng:ny+ng))
    ALLOCATE(ey0(1-ng:nx+ng, 1-ng:ny+ng))
    ALLOCATE(ez0(1-ng:nx+ng, 1-ng:ny+ng))
    ALLOCATE(bx0(1-ng:nx+ng, 1-ng:ny+ng))
    ALLOCATE(by0(1-ng:nx+ng, 1-ng:ny+ng))
    ALLOCATE(bz0(1-ng:nx+ng, 1-ng:ny+ng))
#endif
    ...
    ! Static current
    ALLOCATE(jx0(1-jng:nx+jng, 1-jng:ny+jng))
    ALLOCATE(jy0(1-jng:nx+jng, 1-jng:ny+jng))
    ALLOCATE(jz0(1-jng:nx+jng, 1-jng:ny+jng))
    ! Static disturp current
    ALLOCATE(jx1(1-jng:nx+jng, 1-jng:ny+jng))
    ALLOCATE(jy1(1-jng:nx+jng, 1-jng:ny+jng))
    ALLOCATE(jz1(1-jng:nx+jng, 1-jng:ny+jng))
