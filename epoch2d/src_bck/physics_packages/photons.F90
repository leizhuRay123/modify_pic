...
CONTAINS
  ...
  SUBROUTINE setup_tables_qed
    ...
    !XY 
    INTEGER :: ixi, intbuf(13),iy,igp,ix
...
#include "triangle/b_part.inc"
  ...
  SUBROUTINE calculate_optical_stokes2(p,b,wei,I1,I2,dir1,dir2)
    ...
    REAL(num), INTENT(OUT) :: I1,I2
    REAL(num), DIMENSION(3):: part_u
...
!     
      ...
      !V =  0
      !WRITE(*,*) x, I1 + I2
      CALL calculate_stokes2_dir(part_u,b,dir1,dir2)
      !dir1 = (/1.0,0.0,0.0/)
      !dir2 = (/0.0,1.0,0.0/)
